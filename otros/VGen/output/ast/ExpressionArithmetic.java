...
public class ExpressionArithmetic extends AbstractExpression {

	public ExpressionArithmetic(Expression left, String op, Expression right) {
		this.left = left;
		this.op = op;
		this.right = right;
	...
	public ExpressionArithmetic(Object left, Object op, Object right) {
