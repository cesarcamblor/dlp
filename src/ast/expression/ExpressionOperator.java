...
public class ExpressionOperator extends AbstractExpression {

	private Expression left;
	private String op;
	private Expression right;
	
	public ExpressionOperator(Expression left, String op, Expression right) {
		this.left = left;
		this.op = op;
		this.right = right;
	...
	public ExpressionOperator(Object left, Object op, Object right) {
