...
public class ExpressionFunctionCall extends AbstractExpression {

	private String name;
	private List<Expression> param;
	private DefinitionFuncion definicion;
	
	public ExpressionFunctionCall(String name, List<Expression> param) {
		this.name = name;
		this.param = param;
	...
	public ExpressionFunctionCall(Object name, Object param) {
