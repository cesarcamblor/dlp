...
public class ExpressionComparision extends AbstractExpression {

	private Expression left;
	private String op;
	private Expression right;
	
	public ExpressionComparision(Expression left, String op, Expression right) {
		this.left = left;
		this.op = op;
		this.right = right;
	...
	public ExpressionComparision(Object left, Object op, Object right) {
